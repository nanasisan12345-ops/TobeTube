...
ジャンルを選ぶと、登録済みの動画から直近の重複を避けて1本を抽選します。お気に入り、最近見た動画、共有リンク、ライト／ダークテーマにも対応しています。
...
利用できるアイコン名は `gamepad`、`music`、`paw`、`cooking`、`compass`、`planet`、`bulb`、`waves` です。未登録の名前は `compass` で表示されます。
